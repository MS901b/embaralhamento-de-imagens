...
var parte_3 = new(Class.create({
    ...
    inicia: function() {
        ...
        var permuta_escolhida = JSON.parse($('SalvaLocal').Pega(nomeSoft, 'valor_inicial_a3p3'));
    ...
    set_inicial: function() {
        ...
        $('SalvaLocal').Salva(nomeSoft, 'valor_inicial_a3p3', this.permuta.resposta);
...
var parte_5 = new(Class.create({
    ...
    salva: function() {
        $('SalvaLocal').Salva(nomeSoft, 'a3_p5_q' + this.selecionada, this.permuta.resposta);
    },
    ...
    ajusta: function() {
        var resp = JSON.parse($('SalvaLocal').Pega(nomeSoft, 'a3_p5_q' + this.selecionada));
...
function corrige_q_10_a(valor) {
    res = montaCiclo(JSON.parse($('SalvaLocal').Pega(nomeSoft, 'a3_p5_q1')))
    if (res == false) {
        return 0;
    } else {
        return [comprimentoCiclo(montaCiclo(JSON.parse($('SalvaLocal').Pega(nomeSoft, 'a3_p5_q1')))) == 6]
    }
...
function corrige_q_10_b(valor) {
    ...
    if (res == false) {
        ...
        return [comprimentoCiclo(montaCiclo(JSON.parse($('SalvaLocal').Pega(nomeSoft, 'a3_p5_q2')))) == 10]
    }
}