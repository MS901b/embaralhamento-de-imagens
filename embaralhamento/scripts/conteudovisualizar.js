	var codigo_do_software = "embaralhamento";
	var nome_do_software = "Embaralhando imagens";
	...
	var FichaTecnica = $H({
		...
		sinopse: {
			titulo: 'Sinopse',
			conteudo: 'Partindo de um exemplo simples, um quebra-cabeças com 9 peças, exploramos o conceito de permutação, não do ponto de vista de contagem, mas da sua estrutura interna de ciclos. A partir dessa estrutura, vemos o que se pode aprender sobre a ordem da permutação, ou seja, sobre o número de vezes que ela tem de ser repetida para se retornar a posição inicial.'
		},
		conteudos: {
			titulo: 'Conteúdo',
			conteudo: 'Permutações; Funções bĳetoras; Mínimo Múltiplo Comum;Números primos, Teorema Fundamental da Aritmética.'
		},
		objetivos: {
			titulo: 'Objetivos',
			conteudo: 'Analisar permutações de elementos do ponto de vista de sua estrutura interna; Introduzir de maneira sutil a noção de grupo de permutação; Resolver um problema que envolve e dá signiﬁcado ao conceito de mínimo múltiplo comum.'
		},
		duracao: {
			titulo: 'Duração',
		...
		requisitos: {
			...
			conteudo: 'Navegador moderno (Chrome 75+ ou Firefox 68.0+). O suporte não é garantido para dispositivos mobiles.'
		},
		acessibilidade: {
