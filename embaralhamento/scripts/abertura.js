...
function analisaAmbiente()
{
	...
	if (!(BrowserDetect.browser=='Firefox' && BrowserDetect.version>=68))
	{
		if (!(BrowserDetect.browser=='Chrome' && BrowserDetect.version>=75))
		{
			...
			conteudo += '<p><a id="fechar_desesperado" style="float:right; href="#">Fechar</a><a id="continuar_mesmo_assim" style="float:right; margin-right:10px;"" href="#">Continuar mesmo assim</a><a style="float:right; margin-right:10px;" href="https://www.google.pt/intl/pt-PT/chrome/?brand=CHBD&gclid=EAIaIQobChMIteHJlKP15gIVkAyRCh1UAwU-EAAYASAAEgJUQPD_BwE&gclsrc=aw.ds">Instalar o Chrome</a></p><br class="limpador" />';
